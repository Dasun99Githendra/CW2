...
class DestinationPage extends StatelessWidget {
  ...
  Hero _buildAnimation(BuildContext context1) {
    return Hero(
      tag: imagePath,
      child: Scaffold(
          floatingActionButton: ButtonTheme(
            minWidth: MediaQuery.of(context1).size.width - 60,
            height: 56,
            child: RaisedButton(
                onPressed: () => {},
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    hotDestinationCard('assets/top2.jpg',
                                        'Adams Peak', '18 Tourist Place', context1),
                                    hotDestinationCard('assets/top3.jpg',
                                        'Nuwara Eliya', '20 Tourist Place', context1),
                                    hotDestinationCard('assets/top4.jpg',
                                        'Anuradhapura', '18 Tourist Place', context1),
                                  ],
                                ),
                              ),
                            ],
